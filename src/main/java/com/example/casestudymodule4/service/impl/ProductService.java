...
public class ProductService implements IProductService {
    ...
    @Override
    public Page<ProductResponse> fetchProductResponse(Pageable pageable) {
        Page<Product> productPage = productRepository.fetchProducts(pageable);
    ...
    @Override
    public Page<ProductResponse> findProductByName(String searchName, Pageable pageable) {
        Page<Product> productPage = productRepository.findProductByName(searchName, pageable);
        List<ProductResponse> productResponses = new ArrayList<>();
